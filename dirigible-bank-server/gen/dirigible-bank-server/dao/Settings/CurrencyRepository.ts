...
export class CurrencyRepository {
    ...
    public customDataCount(): number {
        const resultSet = query.execute('SELECT COUNT(*) AS COUNT FROM "CURRENCY"');
    ...
    private async triggerEvent(data: CurrencyEntityEvent | CurrencyUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("dirigible-bank-server-Settings-Currency", ["trigger"]);
        ...
        producer.topic("dirigible-bank-server-Settings-Currency").send(JSON.stringify(data));
    }
}
