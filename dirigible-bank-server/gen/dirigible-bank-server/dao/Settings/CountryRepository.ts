...
export class CountryRepository {
    ...
    private async triggerEvent(data: CountryEntityEvent | CountryUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("dirigible-bank-server-Settings-Country", ["trigger"]);
        ...
        producer.topic("dirigible-bank-server-Settings-Country").send(JSON.stringify(data));
    }
}
