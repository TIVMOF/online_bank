...
export class CurrencyRepository {
    ...
    private async triggerEvent(data: CurrencyEntityEvent | CurrencyUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("dirigible-bank-server-entities-Currency", ["trigger"]);
        ...
        producer.topic("dirigible-bank-server-entities-Currency").send(JSON.stringify(data));
    }
}
