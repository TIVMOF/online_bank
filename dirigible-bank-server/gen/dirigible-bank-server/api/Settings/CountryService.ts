...
const validationModules = await Extensions.loadExtensionModules("dirigible-bank-server-Settings-Country", ["validate"]);
...
class CountryService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/dirigible-bank-server/gen/dirigible-bank-server/api/Settings/CountryService.ts/" + entity.Id);
