...
const validationModules = await Extensions.loadExtensionModules("dirigible-bank-server-Settings-Currency", ["validate"]);
...
class CurrencyService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/dirigible-bank-server/gen/dirigible-bank-server/api/Settings/CurrencyService.ts/" + entity.Id);
