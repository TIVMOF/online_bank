...
export class CountryRepository {
    ...
    public customDataCount(): number {
        const resultSet = query.execute('SELECT COUNT(*) AS COUNT FROM "PI_COUNTRY"');
    ...
    private async triggerEvent(data: CountryEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("dirigible-bank-server-Countries-Country", ["trigger"]);
        ...
        producer.topic("dirigible-bank-server/Countries/Country").send(JSON.stringify(data));
    }
}