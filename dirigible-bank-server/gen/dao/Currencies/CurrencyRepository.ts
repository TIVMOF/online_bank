...
export class CurrencyRepository {
    ...
    public customDataCount(): number {
        const resultSet = query.execute('SELECT COUNT(*) AS COUNT FROM "PI_CURRENCY"');
    ...
    private async triggerEvent(data: CurrencyEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("dirigible-bank-server-Currencies-Currency", ["trigger"]);
        ...
        producer.topic("dirigible-bank-server/Currencies/Currency").send(JSON.stringify(data));
    }
}