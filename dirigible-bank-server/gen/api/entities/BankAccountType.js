...
const dao = require("dirigible-bank-server/gen/dao/entities/BankAccountType");
...
rs.service()
	...
	.resource("{id}")
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound("BankAccountType not found");
			}
		})
		.produces(["application/json"])
		.catch(function(ctx, error) {
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/dirigible-bank-server/gen/api/BankAccountType.js/" + entity.Id);
