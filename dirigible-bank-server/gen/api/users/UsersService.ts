...
class UsersService {
    ...
    private validateEntity(entity: any): void {
        ...
        if (entity.Country?.length > 20) {
            throw new ValidationError(`The 'Country' exceeds the maximum length of [20] characters`);
        }
        if (entity.City?.length > 20) {
            throw new ValidationError(`The 'City' exceeds the maximum length of [20] characters`);
        }
